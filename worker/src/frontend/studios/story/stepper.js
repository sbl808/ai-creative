// AI Creative Studio — Story Studio / stepper.js (V2 refactor)
// Browser-side stepper — extracted VERBATIM from frontend/story.js (v1, byte-identical slice).
// The whole <script> is reassembled in page.js in the original source order.
export const STEPPER_SCRIPT = `// Branch Stepper State Machine (Main + Video Branch)
