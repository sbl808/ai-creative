// AI Creative Studio — Image Studio / stepper.js (V2 refactor)
// Browser-side stepper — extracted VERBATIM from frontend/image.js (v1, byte-identical slice).
// The whole <script> is reassembled in page.js in the original source order.
export const STEPPER_SCRIPT = `var ST_MODE='main';
var stCur=1;
var stDone={};
var ST_STEPS={
  main:[
    { n:1, label:'01 အချက်အလက်' },
    { n:2, label:'02 Prompt ရလဒ်', req:[1] }
  ],
  image:[
    { n:3, label:'01 ပုံဖန်တီးရန် ပြင်ဆင်ရန်', req:[2] },
    { n:4, label:'02 Image ရလဒ်', req:[3] }
  ]
};
function stMeta(n){
